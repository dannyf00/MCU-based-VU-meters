...
#define LCD_PORT		GPIO			//lcd pins on portc
#define LCD_DIR			TRISIO		//output direction
#define LCD_EN			(1<<2)		//LCD_EN on RC5
#define LCD_SCK			(1<<4)		//LCD_CLK on RC6
#define LCD_SI			(1<<5)		//spi data in on RC7
